...
if (isset($_REQUEST["submit"])) {
    ...
    $ins = "INSERT INTO member (id,name, date,dob,phone,coach_id) VALUES ('$id','$name','$date','$dob','$phone','$coach_id')";
...
<form>
  ...
  <div class="form-group">
    <label for="inputAddress2">Coach_Id</label>
    <input type="text" name="coach_id" class="form-control" id="inputAddress2" placeholder="Coach_id">
  </div>
